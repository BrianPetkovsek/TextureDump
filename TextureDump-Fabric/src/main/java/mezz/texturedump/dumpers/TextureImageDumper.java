...
import static net.minecraft.util.math.MathHelper.floorLog2;
...
public class TextureImageDumper {
	...
	public static List<Path> saveGlTextures(String name, int textureId, Path texturesDir) throws IOException {
		...
		int mipmapLevels = floorLog2(minimumSize);

		LOGGER.info(String.format("Dumping TextureMap textures to file: %s", name));
